...
def Tor_algebra_to_file(start,end,filtration):
    ...
    for i in range(start,end):
        ...
        for typ in [ 'mutation_mut', 'mutation_wild' ]:
            for atom in ['C','N','O','CN','CO','NO']:
                ...
                for J in [ 2, 3, 99, 100 ]:
                    filepath1 =Pre + 'skempi_tor_algebra_' + str(filtration) + '/' + folder + '_' + typ + '_' + atom + '1_tor_' + str(J) + '_' 
                    get_tor_algebra_I_J(point1,J,filepath1,'rips')
                
                    filepath2 =Pre + 'skempi_tor_algebra_' + str(filtration) + '/' + folder + '_' + typ + '_' + atom + '2_tor_' + str(J) + '_' 
                    get_tor_algebra_I_J(point2,J,filepath2,'rips')
    ...
    for i in range(start,end):
        ...
        for atom in ['C','N','O','CN','CO','NO']:
            ...
            #for J in ['2_h0', '3_h0', '4_h0', '4_h1', '98_h0', '99_h0', '100_h0']:
                    ...
                    # mutation_mut
                    filename5 = Pre + 'skempi_tor_algebra_' + str(filtration) + '/' + folder \
                        + '_mutation_mut_' + atom + '1_tor_' + J + '_statistic_0.25.npy'
                    filename6 = Pre + 'skempi_tor_algebra_' + str(filtration) + '/' + folder \
                        + '_mutation_mut_' + atom + '2_tor_' + J + '_statistic_0.25.npy'
                    
                    
                    # mutation_wild
                    filename7 = Pre + 'skempi_tor_algebra_' + str(filtration) + '/' + folder \
                        + '_mutation_wild_' + atom + '1_tor_' + J + '_statistic_0.25.npy'
                    filename8 = Pre + 'skempi_tor_algebra_' + str(filtration) + '/' + folder \
                        + '_mutation_wild_' + atom + '2_tor_' + J + '_statistic_0.25.npy'
...
def seperate_feature(typ):
    filename = './skempi/feature/' + typ + '_statistic_feature_0.25.npy'
...
Tor_algebra_to_file(0,1131,10)
for typ in ['2_h0','3_h0','99_h0','99_h1','100_h0','100_h1']:
    Tor_algebra_each_feature_to_file(0,1131,10,0.25,typ)
